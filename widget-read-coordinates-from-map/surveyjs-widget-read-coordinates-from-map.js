...
var widgetMap = {
    ...
    isFit: function (question) {
        //we return true if the type of question is readcoordinatesmap
        return question.getType() === 'readcoordinatesmap';
    ...
    //customType - you are creating a new type, like in our example "readcoordinatesmap"
    activatedByChanged: function (activatedBy) {
        //we do not need to check acticatedBy parameter, since we will use our widget for customType only
        //We are creating a new class and derived it from text question type. It means that text model (properties and fuctions) will be available to us
        Survey.JsonObject.metaData.addClass("readcoordinatesmap", [], null, "text");
        //signaturepad is derived from "empty" class - basic question class
        //Survey.JsonObject.metaData.addClass("signaturepad", [], null, "empty");
  
        //Add new property(s)
        //For more information go to https://surveyjs.io/Examples/Builder/?id=addproperties#content-docs
        Survey.JsonObject.metaData.addProperties("readcoordinatesmap", [
    ...
    afterRender: function (question, el) {
        ...
        // surveyJSWidgetreadcoordinatesmap.loadImagesFromJson(el, question);
        ...
        button.onclick = function () {
            ...
            //         // surveyJSWidgetreadcoordinatesmap.addPhoto(el, image);
